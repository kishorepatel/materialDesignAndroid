package in.blogspot.upsolving.immersiveimagestut;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickRadioButton(RadioButton view){
        RadioButton prevCheckedRadio = getSelectedRadio(view);
        if(prevCheckedRadio != null && prevCheckedRadio != view){
            prevCheckedRadio.setChecked(false);
        }
